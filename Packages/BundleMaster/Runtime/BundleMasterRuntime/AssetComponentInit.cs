...
namespace BM
{
    public static partial class AssetComponent
    {
        ...
        public static async ETTask<bool> Initialize(string bundlePackageName, string secretKey = null)
        {
            ...
            string filePath = BundleFileExistPath(bundlePackageName, ConstantDefine.FileLogsFile, true);
            ...
            string dependPath = BundleFileExistPath(bundlePackageName, ConstantDefine.DependLogsFile, true);
            ...
            string groupPath = BundleFileExistPath(bundlePackageName, ConstantDefine.GroupLogsFile, true);
