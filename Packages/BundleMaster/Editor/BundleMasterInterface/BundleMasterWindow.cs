...
namespace BM
{
    ...
    public partial class BundleMasterWindow : EditorWindow
    {
        ...
        private static int _w = 800;
        private static int _h = 400;
        ...
        /// 分包文件资源索引配置
        /// </summary>
        public static string AssetLoadTablePath = "Assets/Editor/BundleMasterBuildSettings/AssetLoadTable.asset";

        /// <summary>
        /// 分包配置信息
        /// </summary>
        public static string AssetsLoadSettingPath = "Assets/Editor/BundleMasterBuildSettings/AssetsLoadSetting";

        /// <summary>
        /// 原生资源包配置信息
        /// </summary>
        public static string AssetsOriginSettingPath = "Assets/Editor/BundleMasterBuildSettings/AssetsOriginSetting";
        ...
        private static void Open(bool focus)
        {
            ...
            _viewSub = false;
            _instance = (BundleMasterWindow)EditorWindow.GetWindow(typeof(BundleMasterWindow), false, "BundleMasterEditor", focus);
            //_instance.position = new Rect(_w / 2, _h / 2, _w, _h);
            _instance.maxSize = new Vector2(_w, _h);
            _instance.minSize = new Vector2(_w / 2, _h);
            //加载配置文件
        ...
        public void OnGUI()
        {
            ...
            GUILayout.Label("当前资源加载模式:    " + GetModeStr(_bundleMasterRuntimeConfig.AssetLoadMode), GUILayout.Width(_w / 4), GUILayout.Height(_h / 8), GUILayout.ExpandWidth(false));
        ...
        private string GetModeStr(AssetLoadMode mode)
        {
            switch (mode)
            {
                case AssetLoadMode.Develop: return mode + "\n(Editor加载)";
                case AssetLoadMode.Local: return mode + "\n(StreamingAssets加载)";
                case AssetLoadMode.Build: return mode + "\n(RemoteServer加载)";
